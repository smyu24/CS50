...
#Linux path
sys.path.append('user_image_gen')
sys.path.insert(0, '/~/project')

import avatar_create
...
def register():
    ...
    if request.method == "POST":
        ...
        avatar_create.main(data)
        print(avatar_create.main(data))
        flash("Registered")
        # redirect the user
...
@app.route("/dna_match", methods=["GET"])
@login_required
def dna_match():
    # no request.method here; nothing to push and pull data from
    return render_template("dna_match.html")